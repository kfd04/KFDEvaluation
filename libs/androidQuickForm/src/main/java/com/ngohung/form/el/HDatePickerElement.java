...
public class HDatePickerElement extends HElement implements OnClickListener{
	...
	public final static SimpleDateFormat STORE_VALUE_DATE_FMT = new SimpleDateFormat("dd-MM-yyyy"); // storing the datevalue into the value as this string format
	...
	public HDatePickerElement(String key, String label, String hint,String validate, boolean
			required, HDataStore store)
	{
	...
	public void onClick(View btn) {
		...
		if(btn instanceof Button && editable)
		{
			...
			//if (validate.equals("Current_Date"))
