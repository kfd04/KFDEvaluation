 ...
 */
public class SmcHighest extends HBaseFormActivity {
    ...
    private SmcHighest mSurvey = this;
    private Database db;
    String smcTitle;
    ...
    private void submitSmcWorkDetails(){
        ...
        Map<String, ArrayList<String>> tableMetadata = getTableMetaData(Database.TABLE_KFD_PLANTATION_SAMPLING_SMC_DETAILS_HIGHEST, db);
 ...
 /*       if(Integer.parseInt(pref.getString(Database.SMC_WORK_ID,"0"))==0) {
        ...
        db.updateTableWithId(Database.TABLE_KFD_PLANTATION_SAMPLING_SMC_DETAILS_HIGHEST,Database.SMC_ID,cv);
    ...
    private void callSMC2() {
        SharedPreferences SMCpref = this.getApplicationContext().getSharedPreferences(SmcPlantationSampling.SMC_PLANTATION_SAMPLING, Context.MODE_PRIVATE);
        ...
        Cursor cursor = db.getSmcNumber2(formId);
